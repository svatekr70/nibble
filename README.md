...
*Nastavení editoru* ukazuje pod tlačítky „Nibble 0.5.1". Hodnotu dosazuje
...
```html
<link rel="stylesheet"
      href="https://cdn.jsdelivr.net/gh/svatekr70/nibble@v0.5.1/dist/nibble.css">
<div id="obsah"><p>Ahoj.</p></div>

<script type="module">
  import { Nibble, attachToolbar, link, image, table }
    from 'https://cdn.jsdelivr.net/gh/svatekr70/nibble@v0.5.1/dist/nibble.min.js';
...
**Verzi v adrese si pište vždycky.** `@v0.5.1` je neměnné — ten soubor už se
